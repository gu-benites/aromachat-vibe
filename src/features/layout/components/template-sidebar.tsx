...
import {
  ...
  Home,
  KanbanSquare,
  LayoutGrid, // Keep for now, or remove if not used by new navItems
  LogOut,
  Mail, // Keep for now, or remove if not used by new navItems
  Menu,
  MessageSquare, // Added for Chat
  Search,
  Settings,
  Target, // Keep for now, or remove if not used by new navItems
  Users, // Added for Contacts
  BellRing,
  Headphones, // Keep for UserMenu or remove
  FileText, // Keep for UserMenu or remove
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  // Example of a section with a submenu, if needed
  // {
  //   title: "Mail",
  //   href: "/mail",
...
const userMenuItems: NavItem[] = [
  ...
  // { title: "Support", href: "/support", icon: <Headphones className="h-5 w-5" /> },
  {
    title: "Settings",
    href: "/settings", // Assuming /settings is the correct route
